...
<body>
	...
	<div class="main">
	   <div class="container">
		  ...
		  <c:url var="cat" value="/managecategory"/>
		  	  <form:form method="POST" commandName="category" action="${cat}"> 
				...
				<div class="account_grid">
					   <div class="btn_form"><input type="submit" value="addCategory" /></div>
...
<%-- 				   <input type="button" class="btn btn-xs btn-danger" value="Delete"/><a href='<c:url value="delete/${name.c_Id}"></c:url>'></a></td> --%>
					...
					<td><div class="btn_form"><a href='<c:url value="/cedit/${name.c_Id}"></c:url>'>Edit</a></div>
<%-- 				  <td><a href='<c:url value="/cedit/${name.c_Id}"></c:url>'>Edit</a></td> --%>
				   <div class="btn_form"><a href='<c:url value="/cdelete/${name.c_Id}"></c:url>'>Delete</a></div></td>
