...
<body>
	...
	<div class="check-out">
         <div class="container">
    	     <h4 class="title">Your transaction is on processing.....</h4>
    	      <table class="table">
				   <tr>
				  ...
				  <c1:forEach var="l" items="${li}">
				  <tr>
				  
				  <td><img src="${img}/${l.getP_Id()}.jpg" style="width:20%" /></td>
				   <td >${l.getP_Name()}</td>
				   <td>${l.getTotalprice()}</td>
					
					
				   <td>
				   <div class="btn_form"><a href='<c:url value="/buy/${l.getP_Id()}"></c:url>'>Buy&nbsp; &nbsp; &nbsp; </a> <a href='<c:url value="/remove/${l.getCartitems_Id()}"></c:url>'>Remove</a></td>
				   </div>
			        </tr>
				   </c1:forEach>
				...
				<center><label>Grand Total=Rs.${c1}</label><div class="btn_form"><a href='<c:url value="/buy"></c:url>'>Buy All&nbsp; &nbsp; &nbsp;</a> <a href='<c:url value="/remove2/${user}"></c:url>'>Remove All</a>
				 </div>
    	     
    	     
    	     
    	     
    	     <p class="cart">Thank you <br>Click<a href="products"> here</a> to continue shopping</p>
    	   </div>
		</div>
	<!-- footer -->
	<div class="footer">
